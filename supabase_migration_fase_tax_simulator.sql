...
ADD COLUMN IF NOT EXISTS shopee_markup_pct NUMERIC DEFAULT 20.0,
...
ADD COLUMN IF NOT EXISTS tiktok_markup_pct NUMERIC DEFAULT 15.0;
...
UPDATE store_settings SET 
  ...
  shopee_markup_pct = COALESCE(shopee_markup_pct, 20.0),
  ...
  tiktok_markup_pct = COALESCE(tiktok_markup_pct, 15.0);
